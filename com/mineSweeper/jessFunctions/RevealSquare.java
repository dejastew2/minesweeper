...
// reveals a square in the minefield (called from the Jess code)
public class RevealSquare implements Userfunction {
   MineFieldPanel mfPanel;

   public RevealSquare(MineFieldPanel theMfPanel) {
